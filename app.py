...
# --- FIREBASE SETUP ---
# Logic to handle both local development and Vercel deployment
...
if service_account_env:
    ...
    # Use local file (VS Code / Localhost)
    # Ensure this file is in your .gitignore so it doesn't get pushed to GitHub!
    cred = credentials.Certificate("serviceAccountKey.json")
